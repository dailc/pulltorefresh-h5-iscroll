...
(function(exports, CommonTools) {
	...
	var PullToRefresh = CommonTools.core.extend({
		...
		_initPocket: function() {
			...
			if(options.down && options.down.hasOwnProperty('callback')) {
				...
				this.piecontainer = this.container.querySelector('.pie-anim-container');
				this.topcaption = this.container.querySelector('.pull-caption');
    ...
    CommonTools.namespace('skin.type4', PullToRefresh);
